...
public class Choke1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadLocale();
        setContentView(R.layout.activity_choke1);

        imageView = findViewById(R.id.imgback);
        tvUser= findViewById(R.id.selectedUser);
        tvUser.setText(R.string.chock1);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Choke1Activity.this, EmergencyActivity.class);
